...
This preview mounts the actual Vue 3 `Croppa` component from `v2/src`. Choose an image, move and zoom it below the fixed viewport, rotate or flip it, remove it, and download the crop.
